import pytest
from project_package.page_objects.login_page import LoginPage
from project_package.utilities.config_reader import get_resource_url, get_browser_id, get_valid_user_data
from project_package.utilities.driver_factory import driver_factory
